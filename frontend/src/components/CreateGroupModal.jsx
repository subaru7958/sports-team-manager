        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-in fade-in duration-200">
            <div className="bg-white w-full max-w-[640px] rounded-xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
                ...
                <div className="flex items-center justify-between px-8 py-6 border-b border-slate-200">
                    <h3 className="text-2xl font-black text-[#111817] tracking-tight">Create Season Group</h3>
                    ...
                    <div className="px-8 py-6">
                            ...
                            <div className="flex flex-col gap-3">
                                ...
                                <div className="border border-slate-200 rounded-lg max-h-48 overflow-y-auto">
                                    {resourcesLoading ? (
                                        ...
                                        <div className="py-8 text-center text-slate-400 text-sm">No coaches found for {selectedSeason?.discipline}</div>
                                    )}
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col gap-3">
                                ...
                                <div className="border border-slate-200 rounded-lg max-h-48 overflow-y-auto">
                                    {resourcesLoading ? (
                                        ...
                                        <div className="py-8 text-center text-slate-400 text-sm">No athletes found for {selectedSeason?.discipline}</div>
                                    )}
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="mt-8 p-4 rounded-lg flex items-start gap-3" style={{ backgroundColor: `${primaryColor}05`, borderWidth: '1px', borderColor: `${primaryColor}20` }}>
                            ...
                            <p className="text-xs text-[#111817] leading-relaxed">
                                <span className="font-bold">Pro Tip:</span> Groups allow you to organize training sessions and track performance metrics for this unit. Ensure at least one primary coach is assigned.
                            </p>
                        </div>
